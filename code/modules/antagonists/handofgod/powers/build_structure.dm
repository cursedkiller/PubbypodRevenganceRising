/datum/action/cooldown/hog_build_structure
...
/datum/action/cooldown/hog_build_structure/IsAvailable(feedback = FALSE)
	. = ..()
	if(!.)
		return FALSE
...
/datum/action/cooldown/hog_build_structure/Activate(atom/target)
	var/mob/camera/god/deity = owner
