...
/datum/mind/Topic(href, href_list)
	...
	if (href_list["role_edit"])
		...
		switch(href_list["common"])
			...
			if("handofgod")
				switch(href_list["handofgod_action"])
					if("red_god")
						make_Handofgod_god(HOG_TEAM_RED)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Red Deity.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Red Deity.")
					if("blue_god")
						make_Handofgod_god(HOG_TEAM_BLUE)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Blue Deity.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Blue Deity.")
					if("red_prophet")
						make_Handofgod_prophet(HOG_TEAM_RED)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Red Prophet.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Red Prophet.")
					if("blue_prophet")
						make_Handofgod_prophet(HOG_TEAM_BLUE)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Blue Prophet.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Blue Prophet.")
					if("red_follower")
						make_Handofgod_follower(HOG_TEAM_RED)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Red Follower.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Red Follower.")
					if("blue_follower")
						make_Handofgod_follower(HOG_TEAM_BLUE)
						message_admins("[key_name_admin(usr)] has made [key_name(current)] a Blue Follower.")
						log_admin("[key_name(usr)] has made [key_name(current)] a Blue Follower.")
					if("clear")
						remove_hog_follower_prophet()
						to_chat(current, span_danger("<B>Your faith has been stripped away!</B>"))
						message_admins("[key_name_admin(usr)] has removed [key_name(current)]'s Hand of God roles.")
						log_admin("[key_name(usr)] has removed [key_name(current)]'s Hand of God roles.")
